...
<form action="<?php echo JRoute::_('index.php?option=com_jotcache'); ?>" method="post" name="adminForm_crawlerext" id="adminForm_Crawlerext">
    <h3><?php echo Text::_('PLG_JCPLUGINS_CRAWLEREXT_TITLE'); ?></h3>
    <table class="adminlist" style="width:400px;">
        <tr>
            <td style="padding-left: 0;" class="hasTip" title="<?php echo Text::_('PLG_JCPLUGINS_CRAWLEREXT_DEPTH_DESC'); ?>"><?php echo Text::_('PLG_JCPLUGINS_CRAWLEREXT_DEPTH'); ?> </td>
