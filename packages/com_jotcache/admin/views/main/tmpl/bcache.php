<?php
	...
	ToolbarHelper::title(Text::_('JOTCACHE_BCACHE_TITLE'), 'jotcache-logo.gif');
	$bar = Factory::getContainer()->get(ToolbarFactoryInterface::class)->createToolbar('toolbar');
	$msg = Text::_('JOTCACHE_RS_REFRESH_DESC');
	ToolbarHelper::custom('bcapply', 'apply.png', 'apply.png', 'JAPPLY', false);
	ToolbarHelper::spacer();
	ToolbarHelper::custom('bcsave', 'save.png', 'save.png', 'JSAVE', false);
	ToolbarHelper::spacer();
	ToolbarHelper::deleteList(Text::_('JOTCACHE_RS_DEL_CONFIRM'), 'bcdelete');
	ToolbarHelper::spacer();
	ToolbarHelper::cancel('display', Text::_('JCANCEL'));
	ToolbarHelper::spacer();
	ToolbarHelper::help('JotCacheHelp', false, $this->url . 'browser_caching');
?>
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped">
                <thead>
                <tr>
                    <th nowrap="nowrap" width="120"><input type="checkbox" name="toggle" value="" onclick="Joomla.checkAll(this);"/>&nbsp;<?php echo Text::_('JOTCACHE_BCACHE_INCLUDED'); ?></th>
                    <th align="center"><?php echo Text::_('JOTCACHE_BCACHE_URI'); ?></th>
                    <th title="<?php echo Text::_('JOTCACHE_BCACHE_TIME'); ?>"><?php echo Text::_('JOTCACHE_BCACHE_TIME'); ?></th>
                </tr>
                </thead>
				<?php
					$rows = $this->data;
